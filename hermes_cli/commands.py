...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("name", "Set this TUI terminal tab title", "Configuration",
               cli_only=True, aliases=("tab-title", "tabtitle"), args_hint="[title|reset]",
               subcommands=("reset", "clear", "default")),
